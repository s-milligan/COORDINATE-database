...
```{r dataflow, fig.cap="Harmonization work flow", fig.align='left', echo=FALSE, cache=TRUE}
...
```{r packages, warning=FALSE, eval=TRUE, echo=TRUE}
...
```
```{r packages2, warning=FALSE, eval=TRUE, echo=FALSE}
# The following packages are useful for writing the remainder of the page
